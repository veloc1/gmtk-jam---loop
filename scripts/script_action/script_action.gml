...
function get_action_description(action) {
    ...
    actions[ACTION.BUILD_MILL] = new Action("Build mill", action_build_mill, [new Req(RESOURCE.FIRE, 1), new Req(RESOURCE.WIND, 1)], [new Req(RESOURCE.BUILDING, 1), new Req(RESOURCE.FIRE, 1)])
...
function _action_show_insufficient_resources(reqs) {
