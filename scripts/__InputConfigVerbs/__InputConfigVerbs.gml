function __InputConfigVerbs()
{
    ...
    if (not INPUT_ON_SWITCH)
    {
        ...
        InputDefineVerb(INPUT_VERB.ACTION1,  "action1",     "Z",            gp_face1);
        InputDefineVerb(INPUT_VERB.ACTION2,  "action2",     "X",            gp_face2);
        InputDefineVerb(INPUT_VERB.ACTION3,  "action3",     "C",            gp_face3);
        InputDefineVerb(INPUT_VERB.ACTION4,  "action4",     "V",            gp_face4);
    ...
    else //Flip A/B over on Switch
    {
        ...
        InputDefineVerb(INPUT_VERB.ACTION1,  "action1",  undefined,   gp_face1);
        InputDefineVerb(INPUT_VERB.ACTION2,  "action2",  undefined,   gp_face2);
        InputDefineVerb(INPUT_VERB.ACTION3,  "action3",  undefined,   gp_face3);
        InputDefineVerb(INPUT_VERB.ACTION4,  "action4",  undefined,   gp_face4);
